...
public class BlackboardCrawler extends WebCrawler {
  ...
  public boolean shouldVisit(Page referringPage, WebURL url) {
    ...
    return !FILTERS.matcher(href).matches() && !href.equals("https://lms.rpi.edu/webapps/login/?action=logout") && href.startsWith("https://lms.rpi.edu/");
  }
...
//      String hashedName = UUID.randomUUID() + extension;
      ...
      try {
        Files.write(page.getContentData(), new File("/tmp/crawl/" + name));
      } catch (IOException e) {
